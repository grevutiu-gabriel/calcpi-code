...
; The file to write
OutFile "CalcPi_${VER_MAJOR}.${VER_MINOR}.${VER_BUILD}_MSVC64_Setup.exe"
...
; Install the Visual C++ 2010 SP1 Redistributable Package (x64)
Section "Visual C++ 2010 SP1 libraries" VCRedist
	...
	IfFileExists "$TEMP\vcredist_x64.exe" ErrorVC2010FileExists
	DetailPrint "Installing Visual C++ 2010 SP1 Redistributable Package (x64)"
	File res\vcredist_x64.exe
...
ErrorVC2010FileExists:
	MessageBox MB_OK|MB_ICONEXCLAMATION "Error while extracting Visual C++ 2010 SP1 Redistributable Package (x64): File already exists"
SectionEnd
